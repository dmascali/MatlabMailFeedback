...
global SENDSTATUS_STATUS SENDSTATUS_TOC_TIME 

if SENDSTATUS_STATUS 
    total_elapsed_time = toc;
    if isempty(SENDSTATUS_TOC_TIME) %firt occurrence of sendmsg
        partial_elapsed_time = [];
        SENDSTATUS_TOC_TIME(end+1) = toc; %append time
    else
        partial_elapsed_time = total_elapsed_time - SENDSTATUS_TOC_TIME(end);
        SENDSTATUS_TOC_TIME(end+1) = toc; %append time
    end
end
